...
- **Baseline directory:** `docs/qa/baselines/2026-03-28/` _(locally generated — not committed to the repo; regenerate with `yarn qa:visual-baseline`)_
- **Manifest:** `docs/qa/baselines/2026-03-28/manifest.json` _(locally generated — not committed to the repo)_
...
- [x] Visual baseline set generated locally and stored in `docs/qa/baselines/2026-03-28/` _(locally generated by `yarn qa:visual-baseline`; not committed to the repo — regenerate as needed)_.
