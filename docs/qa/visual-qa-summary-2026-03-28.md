...
- **Baseline directory:** `docs/qa/baselines/2026-03-28/` _(locally generated by `yarn qa:visual-baseline`; **not committed to the repo** — regenerate on each machine as needed)_
- **Manifest:** `docs/qa/baselines/2026-03-28/manifest.json` _(locally generated alongside screenshots; not committed to the repo)_
